...
CREATE TABLE dbo.Komen (
    userId       INT           NOT NULL,
    videoId      INT           NOT NULL,
    tmpstmp      DATETIME      NOT NULL,
    konten       NVARCHAR(MAX) NOT NULL,
    waktuKomen   TIME          NOT NULL,
    tanggalKomen DATE          NOT NULL,
    CONSTRAINT PK_Komen          PRIMARY KEY (userId, videoId, tmpstmp),
...
INSERT INTO dbo.Video (tglUpld, judul, [desc], durasi, status, chnlId, userId, thumbnail, subtitle)
VALUES
(GETDATE(), 'My First Vlog', 'Sharing my first day as a content creator', 360, 'up', 1, 1, '../img/thumb1.png', NULL),
(GETDATE(), 'Tech Review: New Smartphone', 'Unboxing and testing the latest smartphone', 480, 'up', 2, 2, '../img/thumb2.png', NULL),
(GETDATE(), 'Easy Pasta Recipe', 'Quick dinner recipe you can make in 15 minutes', 600, 'up', 3, 3, '../img/thumb3.png', NULL),
(GETDATE(), 'Gameplay: Level 1-5 Walkthrough', 'Beginner guide for new players', 720, 'up', 4, 4, '../img/thumb4.png', NULL),
(GETDATE(), 'Test title', 'Test desc', 100, 'up', 5, 5, '../img/thumb5.png', NULL),
(GETDATE(), 'Test title', 'Test desc', 100, 'up', 5, 5, '../img/thumb6.png', NULL);
